"""
Django settings for pnumap project.
...
WSGI_APPLICATION = 'pnumap.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'emopstatic')

STATIC_URL = '/emopstatic/'
